...
var ipArduino = 'http://192.168.0.100';
...
function MostraPopUpHorarioArduino(acao) {
    ...
    $("#modalHorarioArduinoTitle").text("Alterar Horario do Equipamento");
...
function MostraPopUpPeriodo(acao) {
    ...
    if (acao == "S3") {
        ...
        $("#modalPeriodoTitle").text("Agendamento para acionamento do Exaustor");
        $("#hrInicio").val(dadosRecebidos.AgeS3HrI);
        $("#hrFim").val(dadosRecebidos.AgeS3HrF);
    }
    else if (acao == "S4") {
        tipoAgendamento = "?AgeS4Hr";
        $("#modalPeriodoTitle").text("Agendamento para acionamento da irrigação");
